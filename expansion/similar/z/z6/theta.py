...
axes.plot(theta/math.pi*180  , z1_m2 , 'k', lw=lwh, label="Z61")
axes.plot(theta/math.pi*180  , z2_m2 , 'r', lw=lwh, label="Z62")
axes.plot(theta/math.pi*180  , z3_m2 , 'b', lw=lwh, label="Z63")
axes.plot(theta/math.pi*180  , z4_m2 , 'k--', lw=lwh, label="Z64")
axes.plot(theta/math.pi*180  , z5_m2 , 'r--', lw=lwh, label="Z65")
axes.plot(theta/math.pi*180  , z6_m2 , 'b--', lw=lwh, label="Z66")
