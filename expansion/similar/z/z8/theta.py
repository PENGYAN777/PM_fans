...
axes.plot(theta/math.pi*180  , z1_m2 , 'k', lw=lwh, label="Z81")
axes.plot(theta/math.pi*180  , z2_m2 , 'r', lw=lwh, label="Z82")
axes.plot(theta/math.pi*180  , z3_m2 , 'b', lw=lwh, label="Z83")
axes.plot(theta/math.pi*180  , z4_m2 , 'k--', lw=lwh, label="Z84")
axes.plot(theta/math.pi*180  , z5_m2 , 'r--', lw=lwh, label="Z85")
axes.plot(theta/math.pi*180  , z6_m2 , 'b--', lw=lwh, label="Z86")
