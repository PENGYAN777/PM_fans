...
fig1.savefig("propylene_Z8_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (z1.iloc[0,-1]-z1_P2*z1.iloc[1,-1])/z1.iloc[0,-1] , color=colors[1], alpha=0.1, lw=lwh, label="Z81")
axes.plot(theta/math.pi*180  , (z2.iloc[0,-1]-z2_P2*z2.iloc[1,-1])/z2.iloc[0,-1], color=colors[1], alpha=0.2,lw=lwh, label="Z82")
axes.plot(theta/math.pi*180  , (z3.iloc[0,-1]-z3_P2*z3.iloc[1,-1])/z3.iloc[0,-1] , color=colors[1], alpha=0.3, lw=lwh, label="Z83")
axes.plot(theta/math.pi*180  , (z4.iloc[0,-1]-z4_P2*z4.iloc[1,-1])/z4.iloc[0,-1] , color=colors[1], alpha=0.4, lw=lwh, label="Z84")
axes.plot(theta/math.pi*180  , (z5.iloc[0,-1]-z5_P2*z5.iloc[1,-1])/z5.iloc[0,-1] , color=colors[1], alpha=0.5, lw=lwh, label="Z85")
axes.plot(theta/math.pi*180  , (z6.iloc[0,-1]-z6_P2*z6.iloc[1,-1])/z6.iloc[0,-1], color=colors[1], alpha=0.6, lw=lwh, label="Z86")
...
axes.set_xlabel('$\\theta$ $[^o]$',fontsize=12)
axes.set_ylabel('$\\Delta 8$',fontsize=12) 
axes.set_title('$Z_t = 0.9$',fontsize=14)
# axes.legend(loc=4 , prop={'size': 10}) # 
fig2.savefig("propylene_Z8_P2_theta.eps")
