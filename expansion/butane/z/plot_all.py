...
fig1.savefig("nbutane_z_M2_theta.eps")
...
# axes.set_title('$Z_t = 0.9$',fontsize=14)
axes.legend(loc=0 , prop={'size': 10}) # 
fig3.savefig("nbutane_z_dp_theta.eps")
...
# axes.set_title('$Z_t = 0.9$',fontsize=14)
# axes.legend(loc=0 , prop={'size': 10}) # 
fig2.savefig("nbutane_z_M2_zt.eps")
...
# axes.set_title('$Z_t = 0.9$',fontsize=14)
# axes.legend(loc=0 , prop={'size': 10}) # 
fig4.savefig("nbutane_z_P2_zt.eps")
