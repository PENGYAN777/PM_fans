...
# zs = 0.85, 0.8, 0.75. 0.7, 0.65, 0.6 
# zs = 0.80# sonic pressure
# gs = 0.9 # sonic Gamma
...
2. compute data 
"""
V,T,M,nu = rk4(1/ds, 200/ds, ts, 1, 0, 1000)
...
pd.DataFrame(pp).to_csv('z2.csv', index_label = "Index", header  = ['pressure']) 
data = pd.read_csv("z2.csv", ",")
# append new columns
