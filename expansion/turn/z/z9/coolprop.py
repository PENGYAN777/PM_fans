...
pt = Pc*0.8 - 0.25e6*0# total pressure
zt = 0.9
...
4. compute data 
"""
V,T,M,nu = rk4(vstar, 300*vstar, Tstar, 1, 0, 1000)
...
pd.DataFrame(pp).to_csv('z1.csv', index_label = "Index", header  = ['pressure']) 
data = pd.read_csv("z1.csv", ",")
# append new columns
