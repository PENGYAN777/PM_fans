...
# 0 1 2 3 3.5 4.2
pt = Pc*1.8 - Pc*0.2*4.2# total pressure
zt = 0.5
...
# p = np.linspace(Pc*0.8,pt,1000) # z1,z2
# p = np.linspace(Pc*0.6,pt,1000) # z3
# p = np.linspace(Pc*0.55,pt,1000) # z4
# p = np.linspace(Pc*0.45,pt,1000) # z5 
p = np.linspace(Pc*0.4,pt,1000) # z6
...
# z3, 4 5 6
V,T,M,nu = rk4(vstar, 9*vstar, Tstar, 1, 0, 1000)
