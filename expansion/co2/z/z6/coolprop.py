...
pt = Pc*1.8 - Pc*0.2*4.5# total pressure
zt = 0.6
...
# p = np.linspace(Pc*0.8,pt,1000) # P<Pc
# p = np.linspace(Pc*0.7,pt,1000) # z3
# p = np.linspace(Pc*0.66,pt,1000) # z4
# p = np.linspace(Pc*0.5,pt,1000) # z5 
