...
def f2(v,T,M):
    if abs(T-Tc)<0.01*Tc:
        T = 0.99*Tc
    g = CP.CoolProp.PropsSI('fundamental_derivative_of_gas_dynamics','T|gas',T,'Dmass',1/v,fluidname ) 
...
def f3(v,T):
    ...
    return  -T/CP.CoolProp.PropsSI('Cvmass','T|gas',T,'Dmass',1/v,fluidname)* CP.CoolProp.PropsSI('d(P)/d(T)|Dmass','P|gas',P,'T',T,fluidname )
