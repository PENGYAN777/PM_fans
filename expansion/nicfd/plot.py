...
axes.plot(z6.iloc[:,5] , z6.iloc[:,6] , 'k--', lw=lwh, label="$Z_t = 0.6$")
# axes.plot(z5.iloc[:,5] , z5.iloc[:,6] , 'r--', lw=lwh, label="$Z_t = 0.5$")
# axes.plot(z4.iloc[:,5] , z4.iloc[:,6] , 'b--', lw=lwh, label="$Z_t = 0.4$")
