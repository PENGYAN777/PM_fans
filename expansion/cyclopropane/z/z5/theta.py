...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[4], alpha=0.1, lw=lwh, label="Z51")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[4], alpha=0.2,lw=lwh,  label="Z52")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[4], alpha=0.3, lw=lwh, label="Z53")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[4], alpha=0.4, lw=lwh, label="Z54")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[4], alpha=0.5, lw=lwh, label="Z55")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[4], alpha=0.6, lw=lwh, label="Z56")
...
fig1.savefig("CycloPropane_z5_M2_theta.pdf")
