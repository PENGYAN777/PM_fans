...
"""
fluidname = "n-Decane"
# CP.CoolProp.set_reference_state(fluidname,'ASHRAE')
...
pt = Pc*0.7 - Pc*0.1*2# total pressure
zt = 0.8
...
p = np.linspace(Pc*0.1, pt,1000) # z1-z5
...
"""
# 1
V,T,M,nu = rk4(vstar, 30*vstar, Tstar, 1, 0, 1000)
...
pd.DataFrame(pp).to_csv('z3.csv', index_label = "Index", header  = ['pressure']) 
data = pd.read_csv("z3.csv", ",")
# append new columns
