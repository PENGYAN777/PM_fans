...
fig1.savefig("R1234yf_z_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (710634-z91_P2*1183770.)/710634, color=colors[0], lw=lwh, label="$Z_t=0.9$")
axes.plot(theta/math.pi*180  , (669939-z92_P2*1116126)/669939 , color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (629007-z93_P2*1048482.)/629007 , color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (587805-z94_P2* 980838)/587805, color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (547144-z95_P2*913194)/547144, color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (506314-z96_P2*845550)/506314 , color=colors[0], lw=lwh)

axes.plot(theta/math.pi*180  , (1449369.-z81_P2*2367540)/1449369. , color=colors[1], lw=lwh, label="$Z_t=0.8$")
axes.plot(theta/math.pi*180  , (1343738-z82_P2*2198430)/1343738 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (1240478-z83_P2*2029320)/1240478 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (1136541-z84_P2*1860210)/1136541 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (1031587-z85_P2*1691100 )/1031587 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (929512-z86_P2*1521990)/929512 , color=colors[1], lw=lwh)

axes.plot(theta/math.pi*180  , (1901006-z71_P2*3043980)/1901006, color=colors[2], lw=lwh, label="$Z_t=0.7$")
axes.plot(theta/math.pi*180  , (1795714-z72_P2*2874870)/1795714 , color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (1691438-z73_P2*2705760)/1691438 , color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (1475776-z74_P2*2367540.)/1475776, color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (1265870-z75_P2*2029320)/1265870, color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (1159393-z76_P2*1860210)/1159393, color=colors[2], lw=lwh)

axes.plot(theta/math.pi*180  , (2602499-z61_P2*4058640)/2602499, color=colors[3], lw=lwh, label="$Z_t=0.6$")
axes.plot(theta/math.pi*180  , (2492468-z62_P2*3889530)/2492468, color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (2383113-z63_P2*3720420)/2383113, color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (2274436-z64_P2*3551310)/2274436 , color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , ( 2166436-z65_P2*3382200)/ 2166436, color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (2059113-z66_P2* 3213090)/2059113 , color=colors[3], lw=lwh)
...
# axes.set_title('$Z_t = 0.9$',fontsize=14)
axes.legend(loc=0 , prop={'size': 10}) # 
fig3.savefig("R1234yf_z_dp_theta.eps")
