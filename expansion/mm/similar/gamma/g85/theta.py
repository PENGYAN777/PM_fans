...
for i in range(50):
    ...
    smallest_p[i] = min([( 1100125-z1_P2[i]*1939000)/1100125, (1398447  -z2_P2[i]*1939000)/1398447, ( 1972578-z3_P2[i]*1939000)/1972578,
                         ( 2372218-z4_P2[i]*1939000)/2372218, (2653654 -z5_P2[i]*1939000)/2653654, (1651740 -z6_P2[i]*1939000)/1651740]) 
    largest_p[i] = max([( 1100125-z1_P2[i]*1939000)/1100125, (1398447  -z2_P2[i]*1939000)/1398447, ( 1972578-z3_P2[i]*1939000)/1972578,
                         ( 2372218-z4_P2[i]*1939000)/2372218, (2653654 -z5_P2[i]*1939000)/2653654, (1651740 -z6_P2[i]*1939000)/1651740])
...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[0], alpha=0.1, lw=lwh, label="G851")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[0], alpha=0.2,lw=lwh, label="G852")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[0], alpha=0.3, lw=lwh, label="G853")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[0], alpha=0.4, lw=lwh, label="G854")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[0], alpha=0.5, lw=lwh, label="G855")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[0], alpha=0.6, lw=lwh, label="G856")
...
axes.set_title('$\\Gamma_1 = 0.85$',fontsize=14)
# axes.legend(loc=0 , prop={'size': 10}) # 
fig1.savefig("mm_G85_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , ( 1100125-z1_P2*1939000)/1100125 , color=colors[1], alpha=0.1, lw=lwh, label="G851")
axes.plot(theta/math.pi*180  , (1398447  -z2_P2*1939000)/1398447  , color=colors[1], alpha=0.2,lw=lwh, label="G852")
axes.plot(theta/math.pi*180  , ( 1972578-z3_P2*1939000)/1972578 , color=colors[1], alpha=0.3, lw=lwh, label="G853")
axes.plot(theta/math.pi*180  , ( 2372218-z4_P2*1939000)/2372218 , color=colors[1], alpha=0.4, lw=lwh, label="G854")
axes.plot(theta/math.pi*180  , (2653654 -z5_P2*1939000)/2653654 , color=colors[1], alpha=0.5, lw=lwh, label="G855")
axes.plot(theta/math.pi*180  , (1651740 -z6_P2*1939000)/1651740 , color=colors[1], alpha=0.6, lw=lwh, label="G856")
...
fig2.savefig("mm_G85_P2_theta.eps")
