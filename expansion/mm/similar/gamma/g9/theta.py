...
for i in range(50):
    ...
    smallest_p[i] = min([(1347789 -z1_P2[i]*1939000)/1347789, (233301  -z2_P2[i]*1939000)/233301, (2535451 -z3_P2[i]*1939000)/2535451,
                         (2839402 -z4_P2[i]*1939000)/2839402, (2940719 -z5_P2[i]*1939000)/2940719, (2895689 -z6_P2[i]*1939000)/2895689  ]) 
    largest_p[i] = max([(1347789 -z1_P2[i]*1939000)/1347789, (233301  -z2_P2[i]*1939000)/233301, (2535451 -z3_P2[i]*1939000)/2535451,
                         (2839402 -z4_P2[i]*1939000)/2839402, (2940719 -z5_P2[i]*1939000)/2940719, (2895689 -z6_P2[i]*1939000)/2895689  ])
...
axes.plot(theta/math.pi*180  , (1347789 -z1_P2*1939000)/1347789 , color=colors[1], alpha=0.1, lw=lwh, label="G91")
axes.plot(theta/math.pi*180  , (233301  -z2_P2*1939000)/233301  , color=colors[1], alpha=0.2,lw=lwh, label="G92")
axes.plot(theta/math.pi*180  , (2535451 -z3_P2*1939000)/2535451 , color=colors[1], alpha=0.3, lw=lwh, label="G93")
axes.plot(theta/math.pi*180  , (2839402 -z4_P2*1939000)/2839402 , color=colors[1], alpha=0.4, lw=lwh, label="G94")
axes.plot(theta/math.pi*180  , (2940719 -z5_P2*1939000)/2940719 , color=colors[1], alpha=0.5, lw=lwh, label="G95")
axes.plot(theta/math.pi*180  , (2895689 -z6_P2*1939000)/2895689 , color=colors[1], alpha=0.6, lw=lwh, label="G96")
...
fig2.savefig("mm_g9_P2_theta.eps")
