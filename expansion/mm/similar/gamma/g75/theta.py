...
for i in range(50):
    ...
    smallest_p[i] = min([( 784916 -z1_P2[i]*1939000)/784916, ( 1347789 -z2_P2[i]*1939000)/1347789 , ( 1550423 -z3_P2[i]*1939000)/1550423,
                         (1730542  -z4_P2[i]*1939000)/1730542, (1882518. -z5_P2[i]*1939000)/1882518 , ( 2006350-z6_P2[i]*1939000)/2006350 ]) 
    largest_p[i] = max([( 784916 -z1_P2[i]*1939000)/784916, ( 1347789 -z2_P2[i]*1939000)/1347789 , ( 1550423 -z3_P2[i]*1939000)/1550423,
                         (1730542  -z4_P2[i]*1939000)/1730542, (1882518. -z5_P2[i]*1939000)/1882518 , ( 2006350-z6_P2[i]*1939000)/2006350 ])
...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[0], alpha=0.1, lw=lwh, label="G751")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[0], alpha=0.2,lw=lwh, label="G752")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[0], alpha=0.3, lw=lwh, label="G753")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[0], alpha=0.4, lw=lwh, label="G754")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[0], alpha=0.5, lw=lwh, label="G755")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[0], alpha=0.6, lw=lwh, label="G756")
...
axes.set_title('$\\Gamma_1 = 0.75$',fontsize=14)
# axes.legend(loc=0 , prop={'size': 10}) # 
fig1.savefig("mm_G75_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , ( 784916 -z1_P2*1939000)/784916 , color=colors[1], alpha=0.1, lw=lwh, label="G751")
axes.plot(theta/math.pi*180  , ( 1347789 -z2_P2*1939000)/1347789  , color=colors[1], alpha=0.2,lw=lwh, label="G752")
axes.plot(theta/math.pi*180  , ( 1550423 -z3_P2*1939000)/1550423 , color=colors[1], alpha=0.3, lw=lwh, label="G753")
axes.plot(theta/math.pi*180  , (1730542  -z4_P2*1939000)/1730542  , color=colors[1], alpha=0.4, lw=lwh, label="G754")
axes.plot(theta/math.pi*180  , (1882518. -z5_P2*1939000)/1882518 , color=colors[1], alpha=0.5, lw=lwh, label="G755")
axes.plot(theta/math.pi*180  , ( 2006350-z6_P2*1939000)/2006350 , color=colors[1], alpha=0.6, lw=lwh, label="G756")
...
fig2.savefig("mm_G75_P2_theta.eps")
