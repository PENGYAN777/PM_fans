...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[3], alpha=0.1, lw=lwh, label="G751")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[3], alpha=0.2,lw=lwh, label="G752")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[3], alpha=0.3, lw=lwh, label="G753")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[3], alpha=0.4, lw=lwh, label="G754")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[3], alpha=0.5, lw=lwh, label="G755")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[3], alpha=0.6, lw=lwh, label="G756")
