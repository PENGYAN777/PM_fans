...
plt.plot(g9_s,g9_t,'o' ,color=colors[0], lw = lw)
...
plt.plot(g85_s,g85_t,'o' ,color=colors[1], lw = lw)
...
plt.plot(g8_s,g8_t,'o' ,color=colors[2], lw = lw)
...
plt.plot(g75_s,g75_t,'o' ,color=colors[3], lw = lw)
...
plt.plot(g7_s,g7_t,'o' ,color=colors[5], lw = lw)
