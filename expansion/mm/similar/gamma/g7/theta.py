...
for i in range(50):
    ...
    smallest_p[i] = min([(694856 -z1_P2[i]*1939000)/694856, (829946 -z2_P2[i]*1939000)/ 829946, ( 1246472-z3_P2[i]*1939000)/1246472,
                         ( 1347789-z4_P2[i]*1939000)/1347789 , (2023236 -z5_P2[i]*1939000)/2023236 , (1758686  -z6_P2[i]*1939000)/1758686 ]) 
    largest_p[i] = max([(694856 -z1_P2[i]*1939000)/694856, (829946 -z2_P2[i]*1939000)/ 829946, ( 1246472-z3_P2[i]*1939000)/1246472,
                         ( 1347789-z4_P2[i]*1939000)/1347789 , (2023236 -z5_P2[i]*1939000)/2023236 , (1758686  -z6_P2[i]*1939000)/1758686 ]) 
...
fig1.savefig("mm_G7_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (694856 -z1_P2*1939000)/694856 , color=colors[1], alpha=0.1, lw=lwh, label="G71")
axes.plot(theta/math.pi*180  , (829946 -z2_P2*1939000)/ 829946  , color=colors[1], alpha=0.2,lw=lwh, label="G72")
axes.plot(theta/math.pi*180  , ( 1246472-z3_P2*1939000)/1246472 , color=colors[1], alpha=0.3, lw=lwh, label="G73")
axes.plot(theta/math.pi*180  , ( 1347789-z4_P2*1939000)/1347789 , color=colors[1], alpha=0.4, lw=lwh, label="G74")
axes.plot(theta/math.pi*180  , (2023236 -z5_P2*1939000)/2023236 , color=colors[1], alpha=0.5, lw=lwh, label="G75")
axes.plot(theta/math.pi*180  , (1758686  -z6_P2*1939000)/1758686 , color=colors[1], alpha=0.6, lw=lwh, label="G76")
...
fig2.savefig("mm_G7_P2_theta.eps")
