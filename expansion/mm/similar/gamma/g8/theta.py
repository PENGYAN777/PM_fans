...
for i in range(50):
    ...
    smallest_p[i] = min([ (801802 -z1_P2[i]*1939000)/801802, (1516651   -z2_P2[i]*1939000)/1516651, (1972578 -z3_P2[i]*1939000)/1972578,
                         (2282158  -z4_P2[i]*1939000)/2282158 , (2417247  -z5_P2[i]*1939000)/2417247 , (2411619 -z6_P2[i]*1939000)/2411619  ]) 
    largest_p[i] = max([ (801802 -z1_P2[i]*1939000)/801802, (1516651   -z2_P2[i]*1939000)/1516651, (1972578 -z3_P2[i]*1939000)/1972578,
                         (2282158  -z4_P2[i]*1939000)/2282158 , (2417247  -z5_P2[i]*1939000)/2417247 , (2411619 -z6_P2[i]*1939000)/2411619  ]) 
...
fig1.savefig("mm_G8_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (801802 -z1_P2*1939000)/801802 , color=colors[1], alpha=0.1, lw=lwh, label="G81")
axes.plot(theta/math.pi*180  , (1516651   -z2_P2*1939000)/1516651   , color=colors[1], alpha=0.2,lw=lwh, label="G82")
axes.plot(theta/math.pi*180  , (1972578 -z3_P2*1939000)/1972578, color=colors[1], alpha=0.3, lw=lwh, label="G83")
axes.plot(theta/math.pi*180  , (2282158  -z4_P2*1939000)/2282158  , color=colors[1], alpha=0.4, lw=lwh, label="G84")
axes.plot(theta/math.pi*180  , (2417247 -z5_P2*1939000)/2417247  , color=colors[1], alpha=0.5, lw=lwh, label="G85")
axes.plot(theta/math.pi*180  , (2411619 -z6_P2*1939000)/2411619  , color=colors[1], alpha=0.6, lw=lwh, label="G86")
...
fig2.savefig("mm_G8_P2_theta.eps")
