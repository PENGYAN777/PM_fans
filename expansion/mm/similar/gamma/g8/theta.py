...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[2], alpha=0.1, lw=lwh, label="G81")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[2], alpha=0.2,lw=lwh, label="G82")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[2], alpha=0.3, lw=lwh, label="G83")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[2], alpha=0.4, lw=lwh, label="G84")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[2], alpha=0.5, lw=lwh, label="G85")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[2], alpha=0.6, lw=lwh, label="G86")
