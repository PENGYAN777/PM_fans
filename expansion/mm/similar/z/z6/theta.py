...
for i in range(50):
    ...
    smallest_p[i] = min([ (3296937-z1_P2[i]*1939000)/3296937, (2840875-z2_P2[i]*1939000)/2840875, (2382805-z3_P2[i]*1939000)/2382805,
                        (1842050-z4_P2[i]*1939000)/1842050, (1459008-z5_P2[i]*1939000)/1459008, (991418-z6_P2[i]*1939000)/991418 ]) 
    largest_p[i] = max([ (3296937-z1_P2[i]*1939000)/3296937, (2840875-z2_P2[i]*1939000)/2840875, (2382805-z3_P2[i]*1939000)/2382805,
                        (1842050-z4_P2[i]*1939000)/1842050, (1459008-z5_P2[i]*1939000)/1459008, (991418-z6_P2[i]*1939000)/991418 ]) 
...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[1], alpha=0.1, lw=lwh, label="Z61")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[1], alpha=0.2,lw=lwh, label="Z62")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[1], alpha=0.3, lw=lwh, label="Z63")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[1], alpha=0.4, lw=lwh, label="Z64")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[1], alpha=0.5, lw=lwh, label="Z65")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[1], alpha=0.6, lw=lwh, label="Z66")
...
axes.plot(theta/math.pi*180  , (3296937-z1_P2*1939000)/3296937 , color=colors[1], alpha=0.1, lw=lwh, label="Z61")
axes.plot(theta/math.pi*180  , (2840875-z2_P2*1939000)/2840875 , color=colors[1], alpha=0.2,lw=lwh, label="Z62")
axes.plot(theta/math.pi*180  , (2382805-z3_P2*1939000)/2382805, color=colors[1], alpha=0.3, lw=lwh, label="Z63")
axes.plot(theta/math.pi*180  , (1842050-z4_P2*1939000)/1842050 , color=colors[1], alpha=0.4, lw=lwh, label="Z64")
axes.plot(theta/math.pi*180  , (1459008-z5_P2*1939000)/1459008 , color=colors[1], alpha=0.5, lw=lwh, label="Z65")
axes.plot(theta/math.pi*180  , (991418-z6_P2*1939000)/991418 , color=colors[1], alpha=0.6, lw=lwh, label="Z66")
...
axes.set_title('$Z_t = 0.8$',fontsize=14)
# axes.legend(loc=4 , prop={'size': 10}) # 
fig2.savefig("mm_z6_P2_theta.eps")
