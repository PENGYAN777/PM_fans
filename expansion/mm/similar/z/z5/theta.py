...
for i in range(50):
    ...
    smallest_p[i] = min([(3393155-z1_P2[i]*1939000)/3393155,(2985434-z2_P2[i]*1939000)/2985434,(2552357-z3_P2[i]*1939000)/2552357, 
                         (2103684-z4_P2[i]*1939000)/2103684, (1651383-z5_P2[i]*1939000)/1651383,  (1192358-z6_P2[i]*1939000)/1192358]) 
    largest_p[i] = max([(3393155-z1_P2[i]*1939000)/3393155,(2985434-z2_P2[i]*1939000)/2985434,(2552357-z3_P2[i]*1939000)/2552357, 
                         (2103684-z4_P2[i]*1939000)/2103684, (1651383-z5_P2[i]*1939000)/1651383,  (1192358-z6_P2[i]*1939000)/1192358])
...
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[1], alpha=0.6, lw=lwh, label="Z56")
...
fig1.savefig("mm_Z5_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (3393155-z1_P2*1939000)/3393155, color=colors[1], alpha=0.1, lw=lwh, label="Z51")
axes.plot(theta/math.pi*180  , (2985434-z2_P2*1939000)/2985434 , color=colors[1], alpha=0.2,lw=lwh, label="Z52")
axes.plot(theta/math.pi*180  , (2552357-z3_P2*1939000)/2552357 , color=colors[1], alpha=0.3, lw=lwh, label="Z53")
axes.plot(theta/math.pi*180  ,  (2103684-z4_P2*1939000)/2103684, color=colors[1], alpha=0.4, lw=lwh, label="Z54")
axes.plot(theta/math.pi*180  , (1651383-z5_P2*1939000)/1651383 , color=colors[1], alpha=0.5, lw=lwh, label="Z55")
axes.plot(theta/math.pi*180  , (1192358-z6_P2*1939000)/1192358 , color=colors[1], alpha=0.6, lw=lwh, label="Z56")
...
axes.set_title('$Z_t = 0.8$',fontsize=14)
# axes.legend(loc=4 , prop={'size': 10}) # 
fig2.savefig("mm_Z5_P2_theta.eps")
