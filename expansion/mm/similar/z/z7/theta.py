...
for i in range(50):
    ...
    smallest_p[i] = min([(1842050-z1_P2[i]*1939000)/1842050, (1614170-z2_P2[i]*1939000)/1614170, (1357225-z3_P2[i]*1939000)/1357225,
                         (1100537-z4_P2[i]*1939000)/1100537, (842130-z5_P2[i]*1939000)/842130, (583746-z6_P2[i]*1939000)/583746]) 
    largest_p[i] = max([(1842050-z1_P2[i]*1939000)/1842050, (1614170-z2_P2[i]*1939000)/1614170, (1357225-z3_P2[i]*1939000)/1357225,
                         (1100537-z4_P2[i]*1939000)/1100537, (842130-z5_P2[i]*1939000)/842130, (583746-z6_P2[i]*1939000)/583746]) 
...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[1], alpha=0.1, lw=lwh, label="Z71")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[1], alpha=0.2,lw=lwh, label="Z72")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[1], alpha=0.3, lw=lwh, label="Z73")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[1], alpha=0.4, lw=lwh, label="Z74")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[1], alpha=0.5, lw=lwh, label="Z75")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[1], alpha=0.6, lw=lwh, label="Z76")
...
fig1.savefig("mm_z7_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (1842050-z1_P2*1939000)/1842050, color=colors[1], alpha=0.1, lw=lwh, label="Z71")
axes.plot(theta/math.pi*180  , (1614170-z2_P2*1939000)/1614170, color=colors[1], alpha=0.2,lw=lwh, label="Z72")
axes.plot(theta/math.pi*180  , (1357225-z3_P2*1939000)/1357225 , color=colors[1], alpha=0.3, lw=lwh, label="Z73")
axes.plot(theta/math.pi*180  , (1100537-z4_P2*1939000)/1100537 , color=colors[1], alpha=0.4, lw=lwh, label="Z74")
axes.plot(theta/math.pi*180  , (842130-z5_P2*1939000)/842130 , color=colors[1], alpha=0.5, lw=lwh, label="Z75")
axes.plot(theta/math.pi*180  , (583746-z6_P2*1939000)/583746 , color=colors[1], alpha=0.6, lw=lwh, label="Z76")
...
axes.set_title('$Z_t = 0.8$',fontsize=14)
# axes.legend(loc=4 , prop={'size': 10}) # 
fig2.savefig("mm_z7_P2_theta.eps")
