...
for i in range(50):
    ...
    smallest_p[i] = min([(1582060-z1_P2[i]*1939000)/1582060, (1331849-z2_P2[i]*1939000)/1331849 , (1080330-z3_P2[i]*1939000)/1080330,
                        (828923-z4_P2[i]*1939000)/828923 ,  (577307-z5_P2[i]*1939000)/577307, (326059-z6_P2[i]*1939000)/326059 ]) 
    largest_p[i] = max([(1582060-z1_P2[i]*1939000)/1582060, (1331849-z2_P2[i]*1939000)/1331849 , (1080330-z3_P2[i]*1939000)/1080330,
                        (828923-z4_P2[i]*1939000)/828923 ,  (577307-z5_P2[i]*1939000)/577307, (326059-z6_P2[i]*1939000)/326059 ]) 
...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[1], alpha=0.1, lw=lwh, label="Z81")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[1], alpha=0.2,lw=lwh, label="Z82")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[1], alpha=0.3, lw=lwh, label="Z83")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[1], alpha=0.4, lw=lwh, label="Z84")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[1], alpha=0.5, lw=lwh, label="Z85")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[1], alpha=0.6, lw=lwh, label="Z86")
...
fig1.savefig("mm_z8_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (1582060-z1_P2*1939000)/1582060 , color=colors[1], alpha=0.1, lw=lwh, label="Z81")
axes.plot(theta/math.pi*180  , (1331849-z2_P2*1939000)/1331849 , color=colors[1], alpha=0.2,lw=lwh, label="Z82")
axes.plot(theta/math.pi*180  , (1080330-z3_P2*1939000)/1080330 , color=colors[1], alpha=0.3, lw=lwh, label="Z83")
axes.plot(theta/math.pi*180  , (828923-z4_P2*1939000)/828923 , color=colors[1], alpha=0.4, lw=lwh, label="Z84")
axes.plot(theta/math.pi*180  , (577307-z5_P2*1939000)/577307 , color=colors[1], alpha=0.5, lw=lwh, label="Z85")
axes.plot(theta/math.pi*180  , (326059-z6_P2*1939000)/326059 , color=colors[1], alpha=0.6, lw=lwh, label="Z86")
...
axes.set_title('$Z_t = 0.8$',fontsize=14)
# axes.legend(loc=4 , prop={'size': 10}) # 
fig2.savefig("mm_z8_P2_theta.eps")
