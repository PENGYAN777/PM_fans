...
axes.plot(theta/math.pi*180  , (1521091-z91_P2*2499750)/1521091, color=colors[0], lw=lwh, label="$Z_t=0.9$")
axes.plot(theta/math.pi*180  , (1352050-z92_P2*2222000)/1352050 , color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (1181897-z93_P2*1944250)/1181897 , color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (1013134-z94_P2*1666500)/1013134, color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (844927-z95_P2*1388750)/844927, color=colors[0], lw=lwh)
axes.plot(theta/math.pi*180  , (675608-z96_P2*1111000)/675608 , color=colors[0], lw=lwh)

axes.plot(theta/math.pi*180  , (2585938-z81_P2*4166250)/2585938 , color=colors[1], lw=lwh, label="$Z_t=0.8$")
axes.plot(theta/math.pi*180  , (2242852-z82_P2*3610750)/2242852 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (1898653-z83_P2*3055250)/1898653 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (1552230-z84_P2*2499750)/1552230 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (1206919-z85_P2*1944250 )/1206919 , color=colors[1], lw=lwh)
axes.plot(theta/math.pi*180  , (861608-z86_P2*1388750)/861608 , color=colors[1], lw=lwh)

axes.plot(theta/math.pi*180  , (3532346-z71_P2*5555000)/3532346, color=colors[2], lw=lwh, label="$Z_t=0.7$")
axes.plot(theta/math.pi*180  , (3181474-z72_P2*4999500)/3181474 , color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (2917904-z73_P2*4444000)/2917904 , color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (2474727-z74_P2*3888500)/2474727, color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (2122465-z75_P2*3333000)/2122465, color=colors[2], lw=lwh)
axes.plot(theta/math.pi*180  , (1766868-z76_P2*2777500)/1766868, color=colors[2], lw=lwh)

axes.plot(theta/math.pi*180  , (3993038-z61_P2*6110500)/3993038., color=colors[3], lw=lwh, label="$Z_t=0.6$")
axes.plot(theta/math.pi*180  , (3636606-z62_P2*5555000)/3636606, color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (3279062-z63_P2*4999500)/3279062, color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (2917904-z64_P2*4444000)/2917904 , color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (2552297-z65_P2*3888500)/2552297, color=colors[3], lw=lwh)
axes.plot(theta/math.pi*180  , (2184744-z66_P2*3333000)/2184744 , color=colors[3], lw=lwh)
