...
for i in range(50):
    ...
    smallest_p[i] = min([(z1.iloc[0,2]-z1_P2[i])/z1.iloc[0,2], (z2.iloc[0,2]-z2_P2[i])/z2.iloc[0,2], (z3.iloc[0,2]-z3_P2[i])/z3.iloc[0,2],
                         (z4.iloc[0,2]-z4_P2[i])/z4.iloc[0,2], (z5.iloc[0,2]-z5_P2[i])/z5.iloc[0,2], (z6.iloc[0,2]-z6_P2[i])/z6.iloc[0,2] ]) 
    largest_p[i] = max([(z1.iloc[0,2]-z1_P2[i])/z1.iloc[0,2], (z2.iloc[0,2]-z2_P2[i])/z2.iloc[0,2], (z3.iloc[0,2]-z3_P2[i])/z3.iloc[0,2],
                         (z4.iloc[0,2]-z4_P2[i])/z4.iloc[0,2], (z5.iloc[0,2]-z5_P2[i])/z5.iloc[0,2], (z6.iloc[0,2]-z6_P2[i])/z6.iloc[0,2] ]) 
...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[0], alpha=0.1, lw=lwh, label="G71")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[0], alpha=0.2, lw=lwh, label="G72")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[0], alpha=0.3, lw=lwh, label="G73")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[0], alpha=0.4, lw=lwh, label="G74")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[0], alpha=0.5, lw=lwh, label="G75")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[0], alpha=0.6, lw=lwh, label="G76")
...
axes.set_title('$\\Gamma_1 = 0.7$',fontsize=14)
axes.legend(loc=0 , prop={'size': 10}) # 
fig1.savefig("mdm_G7_M2_theta.pdf")
...
axes.plot(theta/math.pi*180  , (z1.iloc[0,2]-z1_P2)/z1.iloc[0,2] , color=colors[1], alpha=0.1, lw=lwh, label="G71")
axes.plot(theta/math.pi*180  , (z2.iloc[0,2]-z2_P2)/z2.iloc[0,2] , color=colors[1], alpha=0.2,lw=lwh, label="G72")
axes.plot(theta/math.pi*180  ,(z3.iloc[0,2]-z3_P2)/z3.iloc[0,2]  , color=colors[1], alpha=0.3, lw=lwh, label="G73")
axes.plot(theta/math.pi*180  , (z4.iloc[0,2]-z4_P2)/z4.iloc[0,2] , color=colors[1], alpha=0.4, lw=lwh, label="G74")
axes.plot(theta/math.pi*180  , (z5.iloc[0,2]-z5_P2)/z5.iloc[0,2], color=colors[1], alpha=0.5, lw=lwh, label="G75")
axes.plot(theta/math.pi*180,  (z6.iloc[0,2]-z6_P2)/z6.iloc[0,2] , color=colors[1], alpha=0.6, lw=lwh, label="G76")
...
fig2.savefig("mdm_G7_P2_theta.eps")
