...
axes.plot(theta/math.pi*180  , z1_m2 , color=colors[4], alpha=0.1, lw=lwh, label="G51")
axes.plot(theta/math.pi*180  , z2_m2 , color=colors[4], alpha=0.2, lw=lwh, label="G52")
axes.plot(theta/math.pi*180  , z3_m2 , color=colors[4], alpha=0.3, lw=lwh, label="G53")
axes.plot(theta/math.pi*180  , z4_m2 , color=colors[4], alpha=0.4, lw=lwh, label="G54")
axes.plot(theta/math.pi*180  , z5_m2 , color=colors[4], alpha=0.5, lw=lwh, label="G55")
axes.plot(theta/math.pi*180  , z6_m2 , color=colors[4], alpha=0.6, lw=lwh, label="G56")
