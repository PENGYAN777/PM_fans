...
fig1.savefig("mdm_Z5_M2_theta.eps")
...
axes.plot(theta/math.pi*180  , (z6.iloc[0,-1]-z6_P2*z6.iloc[1,-1])/z6.iloc[0,-1], color=colors[1], alpha=0.6, lw=lwh, label="Z56")
...
axes.set_title('$Z_t = 0.5$',fontsize=14)
# axes.legend(loc=4 , prop={'size': 10}) # 
fig2.savefig("mdm_Z5_P2_theta.eps")
